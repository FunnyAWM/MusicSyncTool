...
QList<QueryItem> MSTDataSource::getMusic(const short pageNum, const SortByEnum sortBy, const OrderByEnum orderBy) {
    ...
    sql += "LIMIT " + QString::number((pageNum - 1) * 200) + " OFFSET " + QString::number(pageSize);
    prepareStatement(sql);
    execQuery();
